...
To use mPIMC, extract the zip file into somewhere on your $Path, e.g. C:\ProgramData\Mathematica\Applications, strip the version number from the end of the directory name, and then take a look at the example files (Documentation\English\Tutorials).
